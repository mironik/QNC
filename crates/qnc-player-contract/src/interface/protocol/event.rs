...
pub enum BroadcastPlayerProtocolEvent {
    ...
    /// Physical presentation evidence, not a synonym for VideoFrameSubmitted.
    FramePresented {
        frame: FrameNumber,
    },
    DroppedFrame {
...
pub fn map_broadcast_player_protocol_event(
    ...
    match event {
        ...
        BroadcastEvent::PlaybackReadinessChanged {
            ...
            frame,
            ready,
        } => Ok(BroadcastPlayerProtocolEvent::PlaybackReadinessChanged {
            source_id: source_id.clone(),
            frame: *frame,
            ready: *ready,
        }),
        ...
        BroadcastEvent::VideoFrameSubmitted { frame } => {
            Ok(BroadcastPlayerProtocolEvent::VideoFrameSubmitted { frame: *frame })
        }
