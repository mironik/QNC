...
pub enum BroadcastEvent {
    ...
    /// Output accepted the prepared image; not a physical scanout acknowledgment.
    VideoFrameSubmitted {
        frame: FrameNumber,
    },
    /// Requires actual presentation evidence; receipt/upload/GPU completion is not enough.
    FramePresented {
        frame: FrameNumber,
    },
    DroppedFrame {
